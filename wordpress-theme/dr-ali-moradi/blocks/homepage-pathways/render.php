...
$cards  = array_slice( dam_theme_mod_rows( 'pathway_cards', $locale ), 0, count( $icons ) );
?>
	...
	<div class="path-grid">
		<?php foreach ( $cards as $index => $card ) :
			...
			<div class="path-card reveal">
				...
				<a class="button button-small" href="<?php echo esc_url( $url ); ?>"><?php echo esc_html( $card[2] ?? '' ); ?><?php echo dam_icon( 'arrow-right', 16 ); ?></a>
			</div>
		<?php endforeach; ?>
	</div>
</section>
